...
- Duplicate imports/unused imports
  Detects and reports duplicate/unused imports
...
The linting will primarily be done via CLI. CLI syntax to be defined later.

## 5. Expanding for thesis work

The thesis extension of this project will focus on rules and mistakes from the popular book "100 Go Mistakes and How to Avoid Them" by Teiva Harsanyi. Exact rules to be defined later.
